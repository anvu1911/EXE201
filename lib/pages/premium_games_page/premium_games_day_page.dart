...
class PremiumGamesDayPage extends StatefulWidget {
  const PremiumGamesDayPage({super.key});

  @override
  _PremiumGamesDayPage createState() {
    return _PremiumGamesDayPage();
  }
}

class _PremiumGamesDayPage extends State<PremiumGamesDayPage> {
